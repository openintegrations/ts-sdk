...
[![NPM version](https://img.shields.io/npm/v/@openint/backend-sdk.svg)](https://npmjs.org/package/@openint/backend-sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@openint/backend-sdk)
...
```sh
npm install @openint/backend-sdk
```
...
```ts
import Openint from 'npm:@openint/backend-sdk';
