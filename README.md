# Open Int TypeScript API Library
...
This library provides convenient access to the Open Int REST API from server-side TypeScript or JavaScript.
...
1. Via the `OPEN_INT_LOG` environment variable
