...
describe('instantiate client', () => {
  ...
  describe('withOptions', () => {
    test('creates a new client with overridden options', () => {
      const client = new Openint({ baseURL: 'http://localhost:5000/', maxRetries: 3, apiKey: 'My API Key' });
    ...
    test('respects runtime property changes when creating new client', () => {
      const client = new Openint({ baseURL: 'http://localhost:5000/', timeout: 1000, apiKey: 'My API Key' });
